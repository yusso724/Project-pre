...
def Basic_histo(filename):
    ...
    for line in f:
        ...
        X_WIDTH.append((float(xaxis1)-float(xaxis0))/2)
...
#    print(len(barlist))
    ...
    plt.text(Range[1]-(Range[1]-Range[0])*0.05, Mode[2]*10/9, TEXT, fontsize=16, ha='right', va='top', rotation=0)

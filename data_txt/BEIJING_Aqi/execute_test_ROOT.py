...
BIN_Num_2D = 20    # X bin number of 2D
YBIN_Num_2D = 20   # Y bin number of 2D
oneD_NBins = 100

#### option to draw ###
TGraph_2d_basic = 1 ;   Marker_style = ",1"
TH1D_transfer = 0
TH2D_transfer = 0
TH2D_colz_surf3 = 0
TH2D_profileX = 0
...
if TGraph_2d_basic==1:
    TGraph_2D_basic = "root -l -q /Users/leejunho/Desktop/git/python3Env/group_study/fruit_team/ROOT/Project/functions/TGraph_saver/Tree_branches_to_vector.C\("+"'"+'"'+NEW_Tree_PATH+'"'+"'"+Marker_style+"\)"
